/**
    ...
    create an ObjectInputStream on that socket,
     wait for each serialized object to come down it,
      and then hand the object to our subscriber (the comm object).
...
private iObjHandler  ourListnerHandler_;


/**
    Constructor
**/
public ObjHandler(Socket sock, iObjHandler ilh) {
    theSocket_ = sock;
...
run() {
    ...
    //
    boolean done = false;
    System.out.println("ObjHandler object listener running....");
    while ( !done ) {
        try {
            Object o = ois.readObject();
//            System.out.println("ObjHandler got " + o);
            ...
            System.out.println("ObjHandler object listener done.");
	        }
	    } // while
	}   // run
